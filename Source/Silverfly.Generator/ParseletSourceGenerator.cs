...
public class ParseletSourceGenerator : IIncrementalGenerator
{
    ...
    private const string ParseletAttributeSourceCode = $@"// <auto-generated/>

namespace {Namespace};

[System.AttributeUsage(System.AttributeTargets.Class)]
internal class {ParseletAttributeName}(string definition) : System.Attribute
{{
...
";
        ...
        ImmutableArray<ClassDeclarationSyntax> classDeclarations)
    {
        ...
        foreach (var classDeclarationSyntax in classDeclarations)
        {
            ...
            var propertyValue = attribute.ConstructorArguments
    ...
    private string GenerateParseMethod(string definition, INamedTypeSymbol classSymbol)
    {
        ...
        if (prefixType)
        {
            GeneratePrefixParse(builder, definition);
        }

        var infixType = Utils.ImplementsInterface(classSymbol, "IInfixParselet");
        if (infixType)
        {
            GenerateInfixParse(builder, definition);
        }

        return builder.ToString();
    }

    private void GeneratePrefixParse(StringBuilder builder, string definition)
    {
        builder.Append("public AstNode Parse(Parser parser, Token token) {");
        builder.Append("\treturn null;");
        builder.Append('}');
    }

    private void GenerateInfixParse(StringBuilder builder, string definition)
    {

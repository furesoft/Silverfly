...
{
    /// <summary>
    ///     Checks if the current position in the document matches the specified token. If it matches, advances the position;
    ///     otherwise, adds an error message to the document.
    /// </summary>

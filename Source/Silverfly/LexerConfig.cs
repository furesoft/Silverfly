...
public class LexerConfig
{
    ...
    public StringComparison Casing
    {
        get => IgnoreCasing ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal;
    }
    ...
    {
        Symbols = new Dictionary<string, Symbol>(Symbols.OrderByDescending(_ => _.Key.Length));
    }
    ...
    /// <summary>
    ///     Adds a matcher to identify strings enclosed between <paramref name="leftSymbol" /> and
    ///     <paramref name="rightSymbol" />.
    /// </summary>
    ...
    public void MatchString(Symbol leftSymbol, Symbol rightSymbol, bool allowEscapeChars = true,
        bool allowUnicodeChars = true)
    {

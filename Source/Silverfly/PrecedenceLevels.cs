...
public abstract class PrecedenceLevels
{
    ...
    /// <returns>The index of the specified precedence level in the list, or the count of precedence levels if the level is not found.</returns>
    /// <remarks>
    /// This method returns the position of the specified <paramref name="level"/> string in the list of precedence levels.
    ...
    /// <remarks>
    /// This method adds the specified <paramref name="level"/> string to the list of precedence levels if it is not already present.
    ...
    /// <remarks>
    /// This method inserts the specified <paramref name="level"/> string into the list of precedence levels at the given <paramref name="index"/>.
